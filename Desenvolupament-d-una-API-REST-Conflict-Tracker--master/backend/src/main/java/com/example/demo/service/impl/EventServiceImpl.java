...
public class EventServiceImpl implements EventService {
    ...
    public EventServiceImpl(EventRepository eventRepository, ConflictRepository conflictRepository) {
    ...
    public List<EventDTO> findByConflict(Long conflictId) {
        return eventRepository.findByConflictId(conflictId).stream().map(EventMapper::toDTO).collect(Collectors.toList());
    }
